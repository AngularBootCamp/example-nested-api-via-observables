...
/* harmony import */ var _httpUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./httpUtils */ "./src/app/httpUtils.ts");
...
class StarshipApi {
    ...
    starships() {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(shipWrapper => shipWrapper.results), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mergeMap"])(ships => {
            const shipObservables = ships.map((ship) => {
                console.log('GETting film data for ' + ship.name);
                return this.http
                    .get(ship.films[0], {
                    headers: _httpUtils__WEBPACK_IMPORTED_MODULE_3__["jsonRequestHeaders"]
                })
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(film => {
...
StarshipApi.ɵfac = function StarshipApi_Factory(t) { return new (t || StarshipApi)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"])); };
...
function StarshipListComponent_li_7_Template(rf, ctx) { if (rf & 1) {
...
StarshipListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: StarshipListComponent, selectors: [["app-root"]], decls: 9, vars: 3, consts: [[1, "card"], [1, "card-content"], [1, "card-title"], [1, "collection"], ["class", "collection-item", 4, "ngFor", "ngForOf"], [1, "collection-item"]], template: function StarshipListComponent_Template(rf, ctx) { if (rf & 1) {
